...
const render = (lang) => {
  ...
  document.getElementById("btn-en").className =
    lang === "en"
      ? "font-bold text-gray-750 hover:text-gray-750 px-2 focus:outline-none"
      : "text-gray-550 hover:text-gray-750 px-2 focus:outline-none";
  document.getElementById("btn-sv").className =
    lang === "sv"
      ? "font-bold text-gray-750 hover:text-gray-750 px-2 focus:outline-none"
      : "text-gray-550 hover:text-gray-750 px-2 focus:outline-none";
